...
<div class="parent">
        <div class="childleft">
            <a href="userAdd.php"><img src="AddUser.png" class="logo-img"></a>

        </div>
        <div class="childright">
        <a href="Items.php"><img src="AddDevice.png" class="logo-img"></a>

        </div>
    </div>
    <div class="parent1">
        <div class="childleft">
            <a href="Users.php"><img src="UserList.png" class="logo-img"></a>
